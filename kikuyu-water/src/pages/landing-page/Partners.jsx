      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-10">
          ...
          <div className="bg-neutral rounded-xl p-6 sm:p-8 text-center hover:shadow-lg transition">
            <a href="https://wasreb.go.ke" target="_blank" rel="noopener noreferrer" className="block">
          ...
          {/* Partner 2 */}
          <div className="bg-neutral rounded-xl p-6 sm:p-8 text-center hover:shadow-lg transition">
            <a href="https://kiambu.go.ke" target="_blank" rel="noopener noreferrer" className="block">
              <div className="bg-white w-20 h-20 sm:w-24 sm:h-24 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 shadow-md">
          ...
          {/* Partner 3 */}
          <div className="bg-neutral rounded-xl p-6 sm:p-8 text-center hover:shadow-lg transition">
            <a href="https://kebs.org" target="_blank" rel="noopener noreferrer" className="block">
              <div className="bg-white w-20 h-20 sm:w-24 sm:h-24 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 shadow-md">
          ...
          {/* Partner 4 */}
          <div className="bg-neutral rounded-xl p-6 sm:p-8 text-center hover:shadow-lg transition">
            <a href="https://nema.go.ke" target="_blank" rel="noopener noreferrer" className="block">
              <div className="bg-white w-20 h-20 sm:w-24 sm:h-24 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 shadow-md">
