    ...
    commercial: [
      {
        ...
        description: "Our commitment to service excellence and customer standards.",
        date: "2026-01-03",
        type: "Page",
        fileType: "link",
        fileSize: "",
        downloadUrl: "/departments/commercial#customer-service-charter",
      },
      {
        id: 2,
        title: "Approved tariff schedules",
        description: "Current approved tariff schedules for all customer categories.",
        date: "2025-12-20",
        type: "Page",
        fileType: "link",
        fileSize: "",
        downloadUrl: "/departments/commercial#approved-tariff-schedules",
      },
      {
        id: 3,
        title: "Billing procedures & billing cycles",
        description: "Billing procedures, cycle dates and related customer information.",
        date: "2025-12-15",
        type: "Page",
        fileType: "link",
        fileSize: "",
        downloadUrl: "/departments/commercial#billing-procedures-billing-cycles",
      },
      {
        id: 4,
        title: "New connection procedures & forms",
        description: "Steps and forms required to apply for a new water connection.",
        date: "2025-12-10",
        type: "Page",
        fileType: "link",
        fileSize: "",
        downloadUrl: "/departments/commercial#new-connection-procedures-forms",
      },
      {
        id: 5,
        title: "Disconnection/reconnection guidelines",
        description: "Guidelines for disconnection and reconnection of services.",
        date: "2025-11-30",
        type: "Page",
        fileType: "link",
        fileSize: "",
        downloadUrl: "/departments/commercial#disconnection-reconnection-guidelines",
      },
      {
        id: 6,
        title: "Payment channels & customer FAQs",
        description: "Available payment channels and frequently asked customer questions.",
        date: "2025-11-15",
        type: "Page",
        fileType: "link",
        fileSize: "",
        downloadUrl: "/departments/commercial#payment-channels-customer-faqs",
      },
    ],
    finance: [
      {
